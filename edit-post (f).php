<?php
	...
	$mhs = query("SELECT * FROM post WHERE id = $id")[0];
	
	if(isset($_POST['submit'])){
		$title = strtolower(stripslashes($_POST["title"]));
		$deskripsi = strtolower(stripslashes($_POST["deskripsi"]));
		$tanggal = strtolower(stripslashes($_POST["tanggal"]));
		...
		$sql = "UPDATE post SET title = '$title', deskripsi = '$deskripsi' , tanggal = '$tanggal' , foto = '$foto' WHERE id = $id";
                                    ...
                                    <div class="form-validation">
                                        <form class="form-valide" action="#" method="post" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-12">
                                                <textarea name="deskripsi"><?= $mhs['deskripsi']?></textarea>
                                                    <script>
