          ...
          <div class="col-lg-8 p-r-0 title-margin-right">
            <div class="page-header">
              <div class="page-title">
                <h1>Halo,
                  <span>Selamat Datang <?= $dt['username']?></span>
                </h1>
              </div>
            </div>
          </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="user-photo m-b-30">
                          <img class="img-fluid" src="test/<?php echo $dt['foto']?>" alt="" />
                        </div>
                      </div>
                        <div class="custom-tab user-profile-tab">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="1">
                              <div class="contact-information">
                                ...
                                <div class="name-content">
                                  ...
                                  <span class="phone-number"><?= $dt['username']?></span>
                                </div>
                                <div class="phone-content">
                                  <span class="contact-title">Password:</span>
                                  <span class="phone-number"><?= $dt['password']?></span>
                                </div>
                                <div class="address-content">
                                  <span class="contact-title">Kelamin:</span>
                                  <span class="mail-address"><?= $dt['kelamin']?></span>
                                </div>
                                <div class="email-content">
                                  <span class="contact-title">Email:</span>
                                  <span class="contact-email"><?= $dt['email']?></span>
                                </div>
                              </div>
                              </div>
                            </div>
                          ...
                          <div class="col-5 d-flex">
                                <a href="edit-profile.php?id=<?= $dt['id']?>" class="btn btn-primary" style="margin-top: 7px;width:300px; height: 38px;">Edit</a>
                                <a href="logout.php" class="btn btn-danger mb-2 mt-2" style="width:320px">Logout</a>
                          </div>
                        </div>
                      </div>
                    </div>
