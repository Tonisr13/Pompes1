<?php
  ...
  $data = query ("SELECT * FROM articles ORDER BY id DESC");

	$datas = "SELECT * FROM pengguna";
  
    $query = mysqli_query($connection,$datas);
...
<div class="container head-card w-100">
        ...
        <hr>
        <div class="col-lg-12">
        <div class="bg-light text-center shadow mb-4">
            <table class="table table-hover">
                ...
                <?php $i = 1 ?>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="border">
                                                        <img src="image/<?php echo $row['image']?>" alt="" style="width:120px;">
                                                    </td>
                                                    <td class="border"><?= $row['category']?></td>
                                                    <td class="border"><?= $row['date']?></td>
                                                    <td class="border text-center">
                                                        <a href="edit-post.php?id=<?= $row['id']?>" class="btn btn-primary">Edit</a>
                                                        <a href="delete-this-post.php?id=<?= $row['id']?>" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                                <?php $i++ ?>
                                                <?php endforeach ; ?>
