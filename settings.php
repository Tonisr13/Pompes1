...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        <a class="sidebar-nav nav-link" href="settings.php">
...
<div class="container" style="margin-top: 5em; margin-left: 20em; width: 63em;">
        <h1>User Data</h1>
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <button type="button" class="btn btn-default">Style 1</button>
                            <button type="button" class="btn btn-default">Style 3</button>
                        </div>
                    </td>
                </tr>
                <tr>
